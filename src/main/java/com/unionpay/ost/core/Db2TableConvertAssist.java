...
public class Db2TableConvertAssist {
    ...
    public static List<FieldMeta> obtainFieldMetasForDB2(Connection connection, String tableName, String dbType, List<EntityMeta> entityMetaList) {
        ...
        try {
            ...
            fieldMetaList = obtainFieldMetasFromDB2ResultSet(connection, pkCount, tableName);
     ...
     * @return 属性元数据集合
     */
    private static List<FieldMeta> obtainFieldMetasFromDB2ResultSet(Connection connection, int pkCount, String tableName) {
        List<FieldMeta> fieldMetaList = new ArrayList<FieldMeta>();
        //对于多主键情况,是否有新属性生成
